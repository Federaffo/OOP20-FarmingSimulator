...
public class Resources {
	...
	public static enum textures {
		PLAYER(0), PLAYER_LEFT(1), PLAYER_LEFT2(2), PLAYER_RIGHT(3), PLAYER_RIGHT2(4),PLAYER_UP(5),PLAYER_UP2(6),PLAYER_DOWN(7),PLAYER_DOWN2(8),GRASS(9), FARMLAND(10), WALL(11);
