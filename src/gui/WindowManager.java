...
/**
 * Use for create an istance of the game window.
 *
 */
public class WindowManager extends JFrame {
    ...
    public WindowManager(final Game game) {

        Dimension screenSize = getToolkit().getScreenSize();
        windowSize = new Dimension((int) (screenSize.width * SCREEN_RESIZER),
                (int) ((screenSize.width * SCREEN_RESIZER) * ASPECT_RATIO));
        this.game = game;
     ...
     * @param gameState
     */
    public void setWindow(final GameState gameState) {
